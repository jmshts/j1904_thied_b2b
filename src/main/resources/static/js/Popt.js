...
var Iput = {
    ...
    pop: function() {
        ...
        var $a = document.getElementById("showCity");
        ...
        if ($a) {
            ...
            $a.appendChild($c);
            if ($c) {
                $c.ownerDocument.getElementById('showCity').appendChild($b);
            }
    ...
    colse: function() {
        if (Iput.get(Iput.confg.idIframe)) {
            document.getElementById('showCity').removeChild(Iput.get(Iput.confg.idBox));
            document.getElementById('showCity').removeChild(Iput.get(Iput.confg.idIframe));
        }
